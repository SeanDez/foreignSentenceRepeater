...
import {
  audioParentFolderPath, silenceFolderPath, oneSecondPause, twoSecondPause, threeSecondPause, fourSecondPause, fiveSecondPause,
} from '../../globals';
...
export default class AudioMaker {
   ...
   */
   ...
   public async makeWordAudioFile(): Promise<void> {
     ...
     const wordFileObjects: Array<WordFile> = tempFileNames.map((fileName) => new WordFile(fileName, tempFolder));
